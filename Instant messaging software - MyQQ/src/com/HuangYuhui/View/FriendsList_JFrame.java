...
import com.HuangYuhui.View.function.FriendsList_JFrame_function;
...
public class FriendsList_JFrame extends JFrame implements FriendsList_JFrame_function
{
	 ...
	 * @param no
	 * @return void
	 * @date Jan 3, 2019-12:26:30 PM
	 * @throws no
	 *
	 */
	public void Initialize_PlayMusic()
	{
		/*-----------------------------------------------------------------
		 * Start a new Thread to deal with the function of playing music. |
		 *-----------------------------------------------------------------
		 */
		new Thread()
		{
