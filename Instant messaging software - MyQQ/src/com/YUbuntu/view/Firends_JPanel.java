...
public class Firends_JPanel extends JPanel
{
	...
	public Firends_JPanel()
	{
		...
		label_3.setIcon(new ImageIcon(Firends_JPanel.class.getResource("/Icon/The portrait.png")));
		...
		label_5.setIcon(new ImageIcon(Firends_JPanel.class.getResource("/Icon/The portrait.png")));
		...
		label_7.setIcon(new ImageIcon(Firends_JPanel.class.getResource("/Icon/The portrait.png")));
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING, false)
						...
						.addGroup(groupLayout.createSequentialGroup()
							...
							.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING, false)
								...
								.addComponent(panel, Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 233, GroupLayout.PREFERRED_SIZE))))
					.addContainerGap())
		);
